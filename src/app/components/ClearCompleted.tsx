...
function ClearCompleted({handleModal}:myComponentProps){
    ...
    return(
        <button onClick={deleteCompleted} className="w-fit transition duration-200 ease-in hover:scale-105 bg-lightblue text-white font-medium p-2 rounded-lg">CLEAR COMPLETED</button>
    )
}
